...
public class Mercedes extends Minivans{
    ...
    public Mercedes(final Integer id, final Float weight, final String color, final Integer volume, final Standard standardType,
        ...
        super(id, weight, color, volume, standardType, engineCapacity, price, fuel, numberOfWheels, numberOfRows,
                volumeOfTrunk);
