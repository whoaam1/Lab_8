...
public class Bmw extends Sedan{
    ...
    public Bmw(final Integer id, final Float weight, final String color, final Integer volume, final Standard standardType,
        ...
        super(id, weight, color, volume, standardType, engineCapacity, price, fuel, numberOfWheels, vehicleType,
                volumeOfTrunk);
