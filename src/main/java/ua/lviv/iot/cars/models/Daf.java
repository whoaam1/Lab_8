...
public class Daf extends Truck{
    ...
    public Daf(final Integer id, final Float weight, final String color, final Integer volume, final Standard standardType,
        ...
        super(id, weight, color, volume, standardType, engineCapacity, price, fuel, numberOfWheels, typeOfTrailer,
                typeOfTrucks);
        this.torque = torque;
